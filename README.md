...
- Added a new 'misc' menu with an 'about' submenu, an 'options' submenu, and a 'help' submenu, accessible from main menu and game menu by selecting the "?" icon. In the 'bonus options' submenu, it is possible to:
  ...
  - Toggle if the game asks for the name of a save game
  - Toggle whether the game shows a screenshot of your save games when hovering over them on the load screen ('Off' recommended for low-end devices)​
