...
image america DDDDDD = "america/america DDDDDD.png"
...
label meeting:
    ...
    play music "collision_course_paolo_bolio_hq.ogg"
    pause 0.3
    ...
    with fade_white
    #show sunlight2
    #show upplerleft_yellow
    #show upplerhalf
    #show light_blue
    play music "KidsTrax653_KC07-MuppetsOnTheTitanic-Julin.ogg"
    play sound "sfx/scribbles.wav"
    "Cutscene under construction"
    show england large fufufu-n at pos_transform(x=440, yalign=0.0)
    show england large eh2
    show england large blush shout2
    play sound "sfx/footsteps.wav"
    play sound "sfx/ding12.wav"
    pause 14.0
    ...
    play sound ["<silence 1.5>", "sfx/bang07.ogg"]
    $ eng.screen = 'left_4'
    ...
    play sound "sfx/door_sfx.wav"
    play music "FilmEdge_Casual_Z008-QuirkyBounce-Sorbo.ogg" fadeout 1.0
    pause 0.5
    ...
    with dissolve 
    play sound ["<silence .3>", "sfx/bam10.ogg"]
    $ bul.screen = 'right_3'
    ...
    play sound "sfx/door_sfx.wav"
    play music "International_Uplifting_Dance-full_length_track.ogg"
    pause 0.3
    ...
    play music "19_playful.ogg" fadeout 1.0
    ...
    show america DDDDDD at pos_transform(x=60, yalign=0.0) behind japan
    with dissolve
    $ ame.screen = 'left_1'
    ame "Ｈｅｌｌｏ！日本！"
    ...
    scene bg exterior8 at pan_to_top_ext0
    #show sunlight2
    with fade_white
    na "こうして国際怖い話の会は\nふわふわした感じで始まったのだった…。"
