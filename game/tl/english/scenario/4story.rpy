...
translate english story4_bda42bac:
    ...
    story "Specifically, it involved a suit of armour, on display in the hallway of my house, which seemed to be moving of its own volition at night." id story4_bda42bac
...
translate english story4_bb381755:
    ...
    story "One morning, I noticed that this suit of armour, a purely decorative object, was in a different place than the day before. Furthermore, its exterior seemed shinier. At the time, I didn't give it a second thought..." id story4_bb381755
...
translate english story4_c0cc4035:
    ...
    nvl clear
    story "At first, it was only the noises, but by the third night, the armour began to appear in front of me." id story4_c0cc4035
...
translate english story4_a76262fd:
    ...
    story "However, despite being fully clad in heavy metal, the armour would evade me with ease, even when I ran after it at full speed." id story4_a76262fd
...
translate english story4_d09a6f13:
    ...
    nvl clear
    story "According to my research, the person who commissioned this armour, its original owner, never actually wore it in battle..." id story4_d09a6f13

# game/scenario/4story.rpy:79
translate english story4_21f00a1b:

    # story "この鎧自体最初から\n実用性よりもデザインを重視した\n装飾用の鎧だったのだ。\nなぜ現代になって\n甲冑姿で現れるようになったのか\n謎は深まるばかりだった。" id story4_21f00a1b
    story "This armour itself was, from its creation, ornamental armour that prioritized design over practicality. The mystery only deepened: why did it decide to animate itself in the modern era?" id story4_21f00a1b
...
translate english story4_589fc39b:
    ...
    story "\n\n\n...The suit of armour was sitting in my bedroom!" id story4_589fc39b
...
translate english story4_2b2a9f2e:
    ...
    nvl clear
    story "\n\nThis armour... who was behind it...?!!" id story4_2b2a9f2e
...
# game/scenario/4story.rpy:27
translate english story4_d41d8cd9:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:32
translate english story4_d41d8cd9_1:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:37
translate english story4_d41d8cd9_2:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:48
translate english story4_d41d8cd9_3:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:56
translate english story4_d41d8cd9_4:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:82
translate english story4_d41d8cd9_5:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:113
translate english story4_d41d8cd9_6:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:128
translate english story4_d41d8cd9_7:

    # nvl clear
    nvl clear

# game/scenario/4story.rpy:139
translate english story4_d41d8cd9_8:
