label meeting:
    ...
    $ eng.screen = 'left_4'
    play sound ["<silence 1.5>","sfx/hit34.ogg"]
    ...
    show finland ohdear behind america:
        xalign 1.0 yalign 0.0 yoffset 30
        0.3
        block:
    ...
    show finland nyaaaa behind america:
        xpos 30 ypos 30
        time 1.2
        block:
