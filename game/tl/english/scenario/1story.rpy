...
# game/scenario/1story.rpy:6
translate english story1_18244fb9:

    # na "{size=+2}第一話　フィンランドの怖い話。{/size}"
    na "{size=+2}Chapter 1:  Finland's Scary Story{/size}"

# game/scenario/1story.rpy:18
...
translate english story1_9bbe293f:
    ...
    # story "僕はざくざく派です！"
    story "I like the crunch crunch ones the best!"

# game/scenario/1story.rpy:81
translate english story1_76b2fe88_5:

    # nvl clear
    nvl clear

# game/scenario/1story.rpy:87
...
# game/scenario/1story.rpy:112
translate english story1_40ae678a:

    # story "トコトコ歩いていくと\nちょうど良いくぼみがありまして\n僕はそこで数日間過ごすことにしました。"
    story "I was trotting along, and there was this hollow that was just right, so I decided to spend a few days there."

# game/scenario/1story.rpy:117
...
translate english story1_57af3057:
    ...
    # story "バキバキバキっ！{nw=0.5}"
    story "Crack crack crack!{nw=0.5}"
...
translate english story1_76b2fe88_16:
...
# game/scenario/1story.rpy:360
translate english story1_28ca9edf:
