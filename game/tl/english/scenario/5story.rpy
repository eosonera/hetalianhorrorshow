...
# game/scenario/5story.rpy:5
translate english story5_54b9aadf:

    # na "{size=+2}第五話　イギリスの怖い話。{/size}"
    na "{size=+2}Chapter 5:  England's Scary Story{/size}"

# game/scenario/5story.rpy:13
...
translate english story5_19b7bd1f:
    ...
    # story "\nお前らもそろそろ\n俺に対する認識を改める時期に\n来てるんじゃないか？"
    story "\nIsn't it about time you lot revised your perception of me?"

# game/scenario/5story.rpy:39
translate english story5_76b2fe88_4:

    # nvl clear
    nvl clear

# game/scenario/5story.rpy:42
translate english story5_cf4ddedf:

    # story "だが俺が料理の腕を振るっていた\nまさにあの瞬間。"
    story "But it was at the very moment that I was showing off my cooking skills..."
